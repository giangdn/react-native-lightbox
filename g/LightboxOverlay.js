...
export default class LightboxOverlay extends Component {
    ...
    this._panResponder = PanResponder.create({
      ...
      onPanResponderMove: Animated.event([null, {dy: this.state.pan}], {
        listener: (event, gestureState) => {
          ...
          //     Math.abs(Math.abs(gestureState.dy) - WINDOW_HEIGHT / 2) / 30,
          //   ),
          // });
        },
      }),
  ...
  render() {
    const {isOpen, renderHeader, swipeToDismiss, origin} = this.props;
    ...
    const background = (
      <Animated.View
        ...
        <BlurView
          blurType={
            typeof this.props.blurType !== 'undefined'
              ? this.props.blurType
              : 'light'
          }
          blurAmount={
            typeof this.props.blurAmount !== 'undefined'
              ? this.this.props.blurAmount
              : 10
          }
